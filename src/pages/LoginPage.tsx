...
import { Box, Container, Card, CardContent, Typography, TextField, Button, Alert, Paper } from '@mui/material';
...
const dummyUsers = {
  ...
  'seller@example.com': { password: 'seller123', role: 'seller', name: 'Jane Smith' },
        ...
        <Card sx={{ borderRadius: 4, boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
          <CardContent sx={{ p: 4 }}>
            ...
            <Paper elevation={0} sx={{ p: 3, bgcolor: '#f5f5f5', borderRadius: 2, mb: 3 }}>
              <Typography variant="h6" gutterBottom>Demo Accounts:</Typography>
              ...
              <Typography variant="body2">⚙️ Admin: admin@example.com / admin123</Typography>
            </Paper>
