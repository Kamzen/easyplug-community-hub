          ...
          >
            ...
            <CardContent className="relative p-4 lg:p-6 text-center">
              <div className="relative mb-4">
                <div
                  className={`bg-gradient-to-br ${category.gradient} rounded-2xl w-14 h-14 lg:w-16 lg:h-16 flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 shadow-xl`}
                >
